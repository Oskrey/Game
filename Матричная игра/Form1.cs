        ...
        public void Row()
        {
            for (int i = 2; i <= iteration; i++)
            {
                if (dataGridView1[1, i - 1].Value == "A")
                {
                    ...
                    if (min == a)
                    {
                        dataGridView1.Rows[i - 1].Cells[3].Style.BackColor = Color.LightGreen;
                        dataGridView1[2, i - 1].Value = "α";
                        v2 = min / i;
                    }
                    else if (min == b)
                    {
                        dataGridView1.Rows[i - 1].Cells[4].Style.BackColor = Color.LightGreen;
                        dataGridView1[2, i - 1].Value = "β";
                        v2 = min / i;
                    }
                    else
                    {
                        dataGridView1.Rows[i - 1].Cells[5].Style.BackColor = Color.LightGreen;
                    ...
                    if (dataGridView1[2, i - 1].Value == "α")
                    {
                        ...
                        if (maxx == a1)
                        {
                            dataGridView1.Rows[i - 1].Cells[6].Style.BackColor = Color.IndianRed;
                            dataGridView1.Rows.Add(i + 1, "A");
                        }
                        else if (maxx == a2)
                        {
                            dataGridView1.Rows[i - 1].Cells[7].Style.BackColor = Color.IndianRed;
                            dataGridView1.Rows.Add(i + 1, "B");
                        }
                        else
                        {
                            dataGridView1.Rows[i - 1].Cells[8].Style.BackColor = Color.IndianRed;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (maxmin == minFirstRow)
            {
                if (a11 == maxmin)
                {
                    ...
                    dataGridView1.Rows[0].Cells[3].Style.BackColor = Color.LightGreen;
                    if (maxFirstColumn == a11)
                    {
                        dataGridView1.Rows[0].Cells[6].Style.BackColor = Color.IndianRed;
                        dataGridView1.Rows.Add(2, "A");
                        Row();
                    }
                    else if (maxFirstColumn == a21)
                    {
                        dataGridView1.Rows[0].Cells[7].Style.BackColor = Color.IndianRed;
                        dataGridView1.Rows.Add(2, "B");
                        Row();
                    }
                    else
                    {
                        dataGridView1.Rows[0].Cells[8].Style.BackColor = Color.IndianRed;
                ...
                else if (a12 == maxmin)
                {
                    ...
                    dataGridView1.Rows[0].Cells[4].Style.BackColor = Color.LightGreen;
